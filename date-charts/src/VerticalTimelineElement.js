...
const VerticalTimelineElement = ({
  children, className, contentArrowStyle, contentStyle, date, dateClassName,
  icon, iconClassName, iconOnClick, iconStyle, id, position, style, textClassName, 
  ...
  return(
    <div id={id} className={classNames(className, 'vertical-timeline-element',{
    ...
    <VisibilitySensor {...visibilitySensorProps} onChange={onVisibilitySensorChange}>
      <React.Fragment>
        <span style={iconStyle} onClick={iconOnClick} className={classNames(
        ...
        <div style={contentStyle} className={classNames(textClassName,'vertical-timeline-element-content',
          {
            'bounce-in': visible,
            'is-hidden': !visible,
          }
